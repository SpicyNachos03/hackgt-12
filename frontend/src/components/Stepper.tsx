    ...
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: 'rgba(171, 82, 255, 0.746)', color: 'rgba(171, 82, 255, 0.746)' },
          complete: { scale: 1, backgroundColor: 'rgba(171, 82, 255, 0.746)', color: 'rgba(171, 82, 255, 0.746)' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: 'rgba(171, 82, 255, 0.746)' }
  };
